...
const ContactSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isSupplier': PropertySchema(
      id: 2,
      name: r'isSupplier',
      type: IsarType.bool,
    ),
    r'lastPaymentAmount': PropertySchema(
      id: 3,
      name: r'lastPaymentAmount',
      type: IsarType.double,
    ),
...
void _contactSerialize(
  ...
  writer.writeBool(offsets[2], object.isSupplier);
  writer.writeDouble(offsets[3], object.lastPaymentAmount);
  writer.writeDateTime(offsets[4], object.lastPaymentDate);
  writer.writeString(offsets[5], object.name);
  writer.writeString(offsets[6], object.phone);
  writer.writeLong(offsets[7], object.totalWatts);
}
...
Contact _contactDeserialize(
  ...
  object.id = id;
  object.isSupplier = reader.readBool(offsets[2]);
  object.lastPaymentAmount = reader.readDouble(offsets[3]);
  object.lastPaymentDate = reader.readDateTimeOrNull(offsets[4]);
  object.name = reader.readString(offsets[5]);
  object.phone = reader.readStringOrNull(offsets[6]);
  object.totalWatts = reader.readLong(offsets[7]);
  return object;
}
...
extension ContactByIndex on IsarCollection<Contact> {
  Future<Contact?> getByCode(String code) {
    return getByIndex(r'code', [code]);
  }

  Contact? getByCodeSync(String code) {
  ...
  Future<List<Contact?>> getAllByCode(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
    return getAllByIndex(r'code', values);
  }

  List<Contact?> getAllByCodeSync(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
  ...
  Future<Id> putByCode(Contact object) {
    return putByIndex(r'code', object);
  }

  Id putByCodeSync(Contact object, {bool saveLinks = true}) {
    return putByIndexSync(r'code', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByCode(List<Contact> objects) {
    return putAllByIndex(r'code', objects);
  }

  List<Id> putAllByCodeSync(List<Contact> objects, {bool saveLinks = true}) {
...
extension ContactQueryWhere on QueryBuilder<Contact, Contact, QWhereClause> {
  ...
  QueryBuilder<Contact, Contact, QAfterWhereClause> codeEqualTo(String code) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterWhereClause> codeNotEqualTo(
      String code) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ContactQueryFilter
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> currentBalanceEqualTo(
    double value, {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> currentBalanceLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> currentBalanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> isSupplierEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isSupplier',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition>
      lastPaymentAmountEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastPaymentAmount',
        value: value,
        epsilon: epsilon,
      ));
    });
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> lastPaymentDateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastPaymentDate',
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> lastPaymentDateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> lastPaymentDateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> totalWattsEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> totalWattsGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> totalWattsLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> totalWattsBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ContactQuerySortBy on QueryBuilder<Contact, Contact, QSortBy> {
  QueryBuilder<Contact, Contact, QAfterSortBy> sortByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByCurrentBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByIsSupplier() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSupplier', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByIsSupplierDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSupplier', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByLastPaymentAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentAmount', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByLastPaymentAmountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentAmount', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByLastPaymentDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentDate', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByLastPaymentDateDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> sortByTotalWatts() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalWatts', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> sortByTotalWattsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactQuerySortThenBy
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> thenByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByCurrentBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentBalance', Sort.desc);
    });
  }
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> thenByIsSupplier() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSupplier', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByIsSupplierDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSupplier', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByLastPaymentAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentAmount', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByLastPaymentAmountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentAmount', Sort.desc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByLastPaymentDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentDate', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByLastPaymentDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastPaymentDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<Contact, Contact, QAfterSortBy> thenByTotalWatts() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalWatts', Sort.asc);
    });
  }

  QueryBuilder<Contact, Contact, QAfterSortBy> thenByTotalWattsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalWatts', Sort.desc);
    });
  }
...
extension ContactQueryWhereDistinct
  ...
  QueryBuilder<Contact, Contact, QDistinct> distinctByCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QDistinct> distinctByCurrentBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currentBalance');
    });
  }

  QueryBuilder<Contact, Contact, QDistinct> distinctByIsSupplier() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isSupplier');
    });
  }

  QueryBuilder<Contact, Contact, QDistinct> distinctByLastPaymentAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastPaymentAmount');
    });
  }

  QueryBuilder<Contact, Contact, QDistinct> distinctByLastPaymentDate() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QDistinct> distinctByTotalWatts() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactQueryProperty
  ...
  QueryBuilder<Contact, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'code');
    });
  }

  QueryBuilder<Contact, double, QQueryOperations> currentBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currentBalance');
    });
  }

  QueryBuilder<Contact, bool, QQueryOperations> isSupplierProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSupplier');
    });
  }

  QueryBuilder<Contact, double, QQueryOperations> lastPaymentAmountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastPaymentAmount');
    });
  }

  QueryBuilder<Contact, DateTime?, QQueryOperations> lastPaymentDateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, int, QQueryOperations> totalWattsProperty() {
    return QueryBuilder.apply(this, (query) {
